...
int main(){ //после ебаной стирки у меня заработал код, очень многи варнингов и ошибок было 3:00 (реально 3:00)
...
int StrBackCmp(const void* ptr_str1, const void* ptr_str2){ //0:26 гуд партия довольна (0:57 x2)
